...
export const PROVIDERS: ProviderConfig[] = [
    {
        ...
        models: [
            { id: 'gemini-3.5-flash', label: 'Gemini 3.5 Flash', description: '최신 · 가장 강력 ($1.50/1M)' },
            { id: 'gemini-3.1-flash-lite', label: 'Gemini 3.1 Flash-Lite', description: '신형 가성비 ($0.25/1M)' },
            { id: 'gemini-2.5-flash', label: 'Gemini 2.5 Flash', description: '안정적 · 빠름 · 권장 ($0.30/1M)' },
            { id: 'gemini-2.5-flash-lite', label: 'Gemini 2.5 Flash-Lite', description: '최저가 · 소규모 문서용 ($0.10/1M)' },
            { id: 'gemini-2.5-pro', label: 'Gemini 2.5 Pro', description: '고품질 · 복잡한 문서 ($1.25/1M)' },
        ],
