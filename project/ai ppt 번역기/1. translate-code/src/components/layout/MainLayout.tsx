    ...
    return (
        <div className="bg-white text-black font-display min-h-screen relative flex flex-col">
            <div className="relative z-10 flex flex-col min-h-screen">
                ...
                <main className="flex-1 flex flex-col w-full max-w-[1400px] mx-auto px-6 py-6">
                    <div className="flex-1 border-2 border-border-strong rounded-xl p-6 shadow-card bg-white">
                        {children}
                    </div>
                </main>
